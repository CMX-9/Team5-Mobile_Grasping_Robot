...
Moving forward, we plan to introduce deep learning models such as YOLOv8 to enhance detection accuracy, reduce false detections, and improve adaptability to complex environments.  
